<img src="img/logo.jpg" alt="drawing" width="120"/>
...
5050   |    An attempt to programmatically disable the Windows Firewall using a call to INetFwProfileFirewallEnabled(FALSE
...
<div style="page-break-after: always;"></div>
## Microsoft SQL Server Logs <a name = "SQL"></a>
...
24037   |    Issued an alter resource governor command (action_id ALRS class_type RG)
...
<div style="page-break-after: always;"></div>
## Mapping EVTX to MITRE ATT&CK <a name = "MITRE_ATT&CK"></a>
...
<div style="page-break-after: always;"></div>
### Changelog, Notes and References <a name = "Changelog_and_Notes"></a>
- Microsoft Security Log Events List Documentation Draft.
-  Ref #1: [Windows Security Log Encyclopedia](https://www.ultimatewindowssecurity.com/securitylog/encyclopedia/).
- Ref #2: [EVTX to MITRE ATT&CK](https://github.com/mdecrevoisier/EVTX-to-MITRE-Attack).
